...
import { AboutusCollapse, AboutusContainer, AboutusCoreContainer, AboutusCoreText, AboutusParaContainer, StatementContainer, VisionBoxHeader } from "./PageStyles/aboutUsStyles";
...
const AboutUs: React.FC<IAboutUsProps> = () => {
  ...
  <AboutusContainer>
    ...
    <Col xs={24} sm={24} md={24} lg={10} xl={9}>
      <StatementContainer>
        ...
        <div>
          ...
          <ParaJosefin>Our vision is to support with a listening ear and an empathetic heart in an integrated and relational counseling practise.</ParaJosefin>
        </div>
      </StatementContainer>
    </Col>
    <Col xs={24} sm={24} md={24} lg={2} xl={2}>
    ...
    <StatementContainer>
        ...
        <div>
          ...
          <ParaJosefin>Our mission is to serve the community by bringing healing and hope to individuals, families, couples, and others seeking emotional and relational wellbeing as well as wholesome interpersonal relationships through professional counselling care.</ParaJosefin>
        </div>
      </StatementContainer>
    </Col>
    <Col xs={24} sm={24} md={24} lg={2} xl={2}>
    ...
    <br/>
      <ParaJosefin>Umbartha, a Marathi word meaning ‘threshold’ was originally chosen as the name for a business venture that Manisha Billimoria started in 2014 in a small way with exhibitions and sales of authentic Indian clothing such as sarees sourced directly from the looms of rural Bengal and Gujarat as well as Indian jewelry handicrafted by local Indian artisans as well as cottage industries in Sri Lanka. This was the crossing of a threshold for Manisha who had arrived as a young bride in Sri Lanka in 1996 having had her own fashion designing career in Pune. </ParaJosefin>
    <br/>

      <ParaJosefin>In 2013 Manisha embarked on a study of psychology and counseling and passed out in 2015 with a certified qualification enabling her to begin counseling on a professional basis. Gradually she crossed yet another threshold when she closed down her store and began full time counseling in the same premises having also qualified as a practitioner of Art Therapy , REBT (Rational Emotive Behavior Therapy),EMDR(Eye Movement Desensitisation and Reprocessing)and SST ( Single Session Therapy) methods of counseling. She now shares the premises with colleagues in the same field and Umbartha has taken on a whole new meaning as individual men and women or couples come there to seek counsel, direction, life coaching or just a listening ear and cross their own thresholds into a new way of looking at things. </ParaJosefin>
    </AboutusParaContainer>
    <br/>
    <AboutusCoreText>
    ...
    <AboutusCollapse defaultActiveKey={['1']} onChange={onChange}>
      <Panel header="Christian" key="1">
        <ParaJosefin>We aim to offer guidance by integrating when appropriate Scriptural values and Christian spirituality with insights from psychology, and where possible to invite those we serve to strengthen their relationship with God.</ParaJosefin>
      </Panel>
      <Panel header="Confidential" key="2">
        <ParaJosefin>We aim to provide a safe space by valuing privacy and confidentiality and establishing a culture of trust.</ParaJosefin>
      </Panel>
      <Panel header="Relational" key="3">
        <ParaJosefin>We seek to enter deeply into the lives of those struggling with past trauma, emotional pain, conflicts and life crisis, leading them with love to build confidence, self esteem and to inculcate self worth and self love.</ParaJosefin>
      </Panel>
      <Panel header="Professional" key="4">
        <ParaJosefin>We seek to offer qualitative care by partnering with other professionals who are  committed to both therapeutic excellence and the personal growth of those being served.</ParaJosefin>
      </Panel>
      <Panel header="Innovative" key="5">
        <ParaJosefin>We look for opportunities to develop resources to meet the emerging needs of those we serve to help restore hope, encourage personal growth and heal emotional wounds.</ParaJosefin>
      </Panel>
    </AboutusCollapse>
    </AboutusCoreContainer>
    <br/> <br/><br/>
  ...
  {SERVICES.map((service) => (
    <ServicesBox key={service.key} imagePath={service.imagePath} iconImgePath={service.iconImgePath} heading={service.heading} para={service.para} left={service.left}/>
  ))}
